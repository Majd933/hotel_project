    ...
    <div className="min-h-screen bg-stone-50 p-8">
      <div className="max-w-6xl mx-auto">
        <div className={`flex items-center justify-between mb-8 ${language === "ar" ? "flex-row-reverse" : ""}`}>
          <h1 className={`text-3xl font-bold text-stone-800 ${language === "ar" ? "font-cairo text-right" : "font-playfair text-left"}`}>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <p className={`text-stone-600 ${language === "ar" ? "text-right" : "text-left"}`}>
            {language === "ar" 
          ...
          <div className="mt-8 space-y-4">
            {/* مثال: */}
            <div className={`p-4 border border-stone-200 rounded-lg ${language === "ar" ? "text-right" : "text-left"}`}>
